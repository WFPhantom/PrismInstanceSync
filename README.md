...
--indexDir=<path> - Specify a different directory for packwiz files relative to InstanceSync.jar, useful if other launchers use packwiz, DO NOT CHANGE IF USING DEFAULT PRISM.
